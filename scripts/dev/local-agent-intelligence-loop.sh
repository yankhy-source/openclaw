...
payload = {
    ...
    "reviewPath": sys.argv[11],
    "reviewJsonPath": sys.argv[12],
    "evaluatorAgentId": sys.argv[13] or None,
    "failedCommand": sys.argv[14] or None,
    "selftestStatus": sys.argv[15] or None,
    "selftestMode": sys.argv[16] or None,
    "humanEvalStatus": sys.argv[17] or None,
    "humanWhatsappEvalStatus": sys.argv[18] or None,
    "nextUpgrade": sys.argv[19] or None,
    "reviewText": sys.argv[20] or None,
}
...
eval "$(python3 - <<'PY' "$SELFTEST_SUMMARY_PATH" "$HUMAN_EVAL_SUMMARY_PATH" "$HUMAN_WHATSAPP_EVAL_SUMMARY_PATH"
