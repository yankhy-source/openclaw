...
def main() -> int:
    ...
    if args.json:
        ...
        print(
            ...
            "humanResume={human_resume_status} stressRecovery={stress_status}".format(
        ...
        print(
            ...
            "humanWhatsapp={human_age} humanConversation={human_conversation_age} humanResume={human_resume_age} stressRecovery={stress_age}".format(
