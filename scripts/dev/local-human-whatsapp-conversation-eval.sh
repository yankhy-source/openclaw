...
payload.update(load_report_fields("turn3ContextReport", payload["turn3ContextReportPath"]))
...
assert_whatsapp_context_user_facing_report_template "${WHATSAPP_CONTEXT_USER_FACING_REPORT:-}" "${WHATSAPP_CONTEXT_DECISION_SOURCE:-}" "turn 2 context"
...
assert_whatsapp_context_user_facing_report_template "${WHATSAPP_CONTEXT_USER_FACING_REPORT:-}" "${WHATSAPP_CONTEXT_DECISION_SOURCE:-}" "turn 3 context"
if [[ "$WHATSAPP_CONTEXT_OK" != "1" ]]; then
